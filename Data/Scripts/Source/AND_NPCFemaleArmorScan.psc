...
Function FullAnalyze(Actor ScannedActor, String ActorName)
	AND_Logger.FastLog("<Female NPC Armor Scan> [FullAnalyze] Full Analysis Started for " + ScannedActor + " " + ActorName)
	If ScannedActor.WornHasKeyword(Core.AND_CoversAll) == False
		AND_Logger.FastLog("<Female NPC Armor Scan> [FullAnalyze] No CoversAll Keyword Detected")
		
		Bool HasChestCurtain = ScannedActor.WornHasKeyword(Core.AND_ChestCurtain)
		Bool HasChestCurtainT = ScannedActor.WornHasKeyword(Core.AND_ChestCurtainT)
		
		String HasChestRiskLevel = "None"
		If HasChestCurtain == True || HasChestCurtainT == True
			If ScannedActor.WornHasKeyword(Core.AND_ChestFlashRiskLow)
				HasChestRiskLevel = "Low"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_ChestFlashRisk)
				HasChestRiskLevel = "Normal"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_ChestFlashRiskHigh)
				HasChestRiskLevel = "High"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_ChestFlashRiskExtreme)
				HasChestRiskLevel = "Extreme"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_ChestFlashRiskUltra)
				HasChestRiskLevel = "Ultra"
			EndIf
		EndIf
		
		Bool HasPelvicCurtain = (ScannedActor.WornHasKeyword(Core.AND_PelvicCurtain) || ScannedActor.WornHasKeyword(Core.AND_Miniskirt))
		Bool HasPelvicCurtainT = (ScannedActor.WornHasKeyword(Core.AND_PelvicCurtainT) || ScannedActor.WornHasKeyword(Core.AND_MiniskirtT))
		
		String HasPelvicRiskLevel = "None"
		If HasPelvicCurtain == True || HasPelvicCurtainT == True
			If ScannedActor.WornHasKeyword(Core.AND_PelvicFlashRiskLow)
				HasPelvicRiskLevel = "Low"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_PelvicFlashRisk)
				HasPelvicRiskLevel = "Normal"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_PelvicFlashRiskHigh)
				HasPelvicRiskLevel = "High"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_PelvicFlashRiskExtreme)
				HasPelvicRiskLevel = "Extreme"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_PelvicFlashRiskUltra)
				HasPelvicRiskLevel = "Ultra"
			EndIf
		EndIf
		
		Bool HasAssCurtain = (ScannedActor.WornHasKeyword(Core.AND_AssCurtain) || ScannedActor.WornHasKeyword(Core.AND_Miniskirt))
		Bool HasAssCurtainT = (ScannedActor.WornHasKeyword(Core.AND_AssCurtainT) || ScannedActor.WornHasKeyword(Core.AND_MiniskirtT))
		
		String HasAssRiskLevel = "None"
		If HasAssCurtain == True || HasAssCurtainT == True
			If ScannedActor.WornHasKeyword(Core.AND_AssFlashRiskLow)
				HasAssRiskLevel = "Low"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_AssFlashRisk)
				HasAssRiskLevel = "Normal"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_AssFlashRiskHigh)
				HasAssRiskLevel = "High"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_AssFlashRiskExtreme)
				HasAssRiskLevel = "Extreme"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_AssFlashRiskUltra)
				HasAssRiskLevel = "Ultra"
			EndIf
		EndIf
		
		If VanillaArmorCheck(ScannedActor) == False ;Armor has at least one AND Keyword
			AND_Logger.FastLog("<Female NPC Armor Scan> [FullAnalyze] Armor is not Vanilla")
			;/
			=============
			Top Variables
			=============
			/;
			Bool HasArmorTop = ScannedActor.WornHasKeyword(Core.AND_ArmorTop)
			String HasTopRiskLevel = "None"
			If ScannedActor.WornHasKeyword(Core.AND_ArmorTopT_Low)
				HasTopRiskLevel = "Low"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_ArmorTopT)
				HasTopRiskLevel = "Normal"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_ArmorTopT_High)
				HasTopRiskLevel = "High"
			EndIf
			Bool HasArmorTopT = (HasTopRiskLevel != "None")
			
			Bool HasBra = ScannedActor.WornHasKeyword(Core.AND_Bra)
			String HasBraRiskLevel = "None"
			If ScannedActor.WornHasKeyword(Core.AND_BraT_Low)
				HasBraRiskLevel = "Low"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_BraT)
				HasBraRiskLevel = "Normal"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_BraT_High)
				HasBraRiskLevel = "High"
			EndIf
			Bool HasBraT = (HasBraRiskLevel != "None")
			
			Bool HasBraNoCover = ScannedActor.WornHasKeyword(Core.AND_Bra_NoCover)
			...
			================
			/;
			Bool HasArmorBottom = ScannedActor.WornHasKeyword(Core.AND_ArmorBottom)
			String HasBottomRiskLevel = "None"
			If ScannedActor.WornHasKeyword(Core.AND_ArmorBottomT_Low)
				HasBottomRiskLevel = "Low"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_ArmorBottomT)
				HasBottomRiskLevel = "Normal"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_ArmorBottomT_High)
				HasBottomRiskLevel = "High"
			EndIf
			Bool HasArmorBottomT = (HasBottomRiskLevel != "None")
			
			Bool HasHotpants = ScannedActor.WornHasKeyword(Core.AND_Hotpants)
			String HasHotpantsRiskLevel = "None"
			If ScannedActor.WornHasKeyword(Core.AND_HotpantsT_Low)
				HasHotpantsRiskLevel = "Low"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_HotpantsT)
				HasHotpantsRiskLevel = "Normal"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_HotpantsT_High)
				HasHotpantsRiskLevel = "High"
			EndIf
			Bool HasHotpantsT = (HasHotpantsRiskLevel != "None")
			
			Bool HasShowgirl = ScannedActor.WornHasKeyword(Core.AND_ShowgirlSkirt)
			String HasShowgirlRiskLevel = "None"
			If ScannedActor.WornHasKeyword(Core.AND_ShowgirlSkirtT_Low)
				HasShowgirlRiskLevel = "Low"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_ShowgirlSkirtT)
				HasShowgirlRiskLevel = "Normal"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_ShowgirlSkirtT_High)
				HasShowgirlRiskLevel = "High"
			EndIf
			Bool HasShowgirlT = (HasShowgirlRiskLevel != "None")
			
			Bool HasUnderwear = ScannedActor.WornHasKeyword(Core.AND_Underwear)
			String HasUnderwearRiskLevel = "None"
			If ScannedActor.WornHasKeyword(Core.AND_UnderwearT_Low)
				HasUnderwearRiskLevel = "Low"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_UnderwearT)
				HasUnderwearRiskLevel = "Normal"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_UnderwearT_High)
				HasUnderwearRiskLevel = "High"
			EndIf
			Bool HasUnderwearT = (HasUnderwearRiskLevel != "None")
			Bool HasUnderwearNoCover = ScannedActor.WornHasKeyword(Core.AND_Underwear_NoCover)
			
			Bool HasThong = ScannedActor.WornHasKeyword(Core.AND_Thong)
			String HasThongRiskLevel = "None"
			If ScannedActor.WornHasKeyword(Core.AND_ThongT_Low)
				HasThongRiskLevel = "Low"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_ThongT)
				HasThongRiskLevel = "Normal"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_ThongT_High)
				HasThongRiskLevel = "High"
			EndIf
			Bool HasThongT = (HasThongRiskLevel != "None")
			Bool HasThongNoCover = ScannedActor.WornHasKeyword(Core.AND_Thong_NoCover)
			
			Bool HasCString = ScannedActor.WornHasKeyword(Core.AND_CString)
			String HasCStringRiskLevel = "None"
			If ScannedActor.WornHasKeyword(Core.AND_CStringT_Low)
				HasCStringRiskLevel = "Low"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_CStringT)
				HasCStringRiskLevel = "Normal"
			ElseIf ScannedActor.WornHasKeyword(Core.AND_CStringT_High)
		...
		Else
			AND_Logger.FastLog("<Female NPC Armor Scan> [FullAnalyze] Armor is considered Vanilla")
		...
		EndIf
	Else
		AND_Logger.FastLog("<Female NPC Armor Scan> [FullAnalyze] CoversAll Keyword Detected")
...
Function FinalAnalyze(Actor ScannedActor, String ActorName)
	...
	Else
		...
		ElseIf AND_Bra_Cover == True && AND_Chest_Cover == False
			If ScannedActor.WornHasKeyword(Core.AND_ArmorTopT_Low) || ScannedActor.WornHasKeyword(Core.AND_ArmorTopT) || ScannedActor.WornHasKeyword(Core.AND_ArmorTopT_High)\ 
	...
	Else
		...
		ElseIf AND_Underwear_Cover == True && AND_BottomGenital_Cover == False && AND_BottomAss_Cover == False
			...
			|| ScannedActor.WornHasKeyword(Core.AND_HotpantsT_Low) || ScannedActor.WornHasKeyword(Core.AND_HotpantsT) || ScannedActor.WornHasKeyword(Core.AND_HotpantsT_High)\ 
			|| ScannedActor.WornHasKeyword(Core.AND_ShowgirlSkirtT_Low) || ScannedActor.WornHasKeyword(Core.AND_ShowgirlSkirtT) || ScannedActor.WornHasKeyword(Core.AND_ShowgirlSkirtT_High)\ 
	...
	AND_Logger.FastLog("<Female NPC Armor Scan> [Layer Analyze] Female Armor Scan Finished for " + ScannedActor + " " + ActorName)
EndFunction