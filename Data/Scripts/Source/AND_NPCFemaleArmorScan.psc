...
Function FullAnalyze(Actor ScannedActor, String ActorName)
	Logger.Log("<Female NPC Armor Scan> [FullAnalyze] Full Analysis Started for " + ScannedActor + " " + ActorName)
	If ScannedActor.WornHasKeyword(Core.AND_CoversAll) == False
		Logger.Log("<Female NPC Armor Scan> [FullAnalyze] No CoversAll Keyword Detected")
		...
		If VanillaArmorCheck(ScannedActor) == False ;Armor has at least one AND Keyword
			Logger.Log("<Female NPC Armor Scan> [FullAnalyze] Armor is not Vanilla")
			;/
			=============
			Top Variables
			=============
		...
		Else
			Logger.Log("<Female NPC Armor Scan> [FullAnalyze] Armor is considered Vanilla")
		...
		EndIf
	Else
		Logger.Log("<Female NPC Armor Scan> [FullAnalyze] CoversAll Keyword Detected")
