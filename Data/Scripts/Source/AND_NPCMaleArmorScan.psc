...
Bool Function TopCurtainCheck(Actor ScannedActor)
	If ScannedActor.WornHasKeyword(AND_Main.AND_ChestCurtain_Male)
		If ScannedActor.WornHasKeyword(AND_Main.AND_ChestFlashRiskLow_Male)
			If AND_Main.NPCTopCurtainRoll <= AND_Config.TopCurtainOddsLow_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_ChestFlashRisk_Male)
			If AND_Main.NPCTopCurtainRoll <= AND_Config.TopCurtainOdds_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_ChestFlashRiskHigh_Male)
			If AND_Main.NPCTopCurtainRoll <= AND_Config.TopCurtainOddsHigh_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_ChestFlashRiskExtreme_Male)
			If AND_Main.NPCTopCurtainRoll <= AND_Config.TopCurtainOddsExtreme_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_ChestFlashRiskUltra_Male)
			If AND_Main.NPCTopCurtainRoll <= AND_Config.TopCurtainOddsUltra_Male
				return False
			Else
				return True
			EndIf
	...
	ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_ChestCurtainT_Male)
		If ScannedActor.WornHasKeyword(AND_Main.AND_ChestFlashRiskLow_Male)
			If AND_Main.NPCTopCurtainRoll <= AND_Config.TransparentTopCurtainOddsLow_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_ChestFlashRisk_Male)
			If AND_Main.NPCTopCurtainRoll <= AND_Config.TransparentTopCurtainOdds_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_ChestFlashRiskHigh_Male)
			If AND_Main.NPCTopCurtainRoll <=  AND_Config.TransparentTopCurtainOddsHigh_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_ChestFlashRiskExtreme_Male)
			If AND_Main.NPCTopCurtainRoll <= AND_Config.TransparentTopCurtainOddsExtreme_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_ChestFlashRiskUltra_Male)
			If AND_Main.NPCTopCurtainRoll <= AND_Config.TransparentTopCurtainOddsUltra_Male
				return False
			Else
				return True
			EndIf
...
Bool Function TopTransparentArmorCheck(Actor ScannedActor)
	If ScannedActor.WornHasKeyword(AND_Main.AND_ArmorTopT_Low_Male)
		If AND_Main.NPCTopTransparentRoll <= AND_Config.TransparentTopArmorOdds_Low_Male
			return False
		Else
			return True
		EndIf
	ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_ArmorTopT_Male)
		If AND_Main.NPCTopTransparentRoll <= AND_Config.TransparentTopArmorOdds_Male
			return False
		Else
			return True
		EndIf
	ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_ArmorTopT_High_Male)
		If AND_Main.NPCTopTransparentRoll <= AND_Config.TransparentTopArmorOdds_High_Male
			return False
		Else
			return True
		EndIf
...
Bool Function TransparentBraCheck(Actor ScannedActor)
	If ScannedActor.WornHasKeyword(AND_Main.AND_BraT_Low_Male)
		If AND_Main.NPCBraTransparentRoll <= AND_Config.TransparentBraOdds_Low_Male
			return False
		Else
			return True
		EndIf
	ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_BraT_Male)
		If AND_Main.NPCBraTransparentRoll <= AND_Config.TransparentBraOdds_Male
			return False
		Else
			return True
		EndIf
	ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_BraT_High_Male)
		If AND_Main.NPCBraTransparentRoll <= AND_Config.TransparentBraOdds_High_Male
			return False
		Else
			return True
		EndIf
...
Bool Function PelvicCurtainCheck(Actor ScannedActor)
	If ScannedActor.WornHasKeyword(AND_Main.AND_PelvicCurtain_Male) || ScannedActor.WornHasKeyword(AND_Main.AND_Miniskirt_Male)
		If ScannedActor.WornHasKeyword(AND_Main.AND_PelvicFlashRiskLow_Male)
			If AND_Main.NPCPelvicCurtainRoll <= AND_Config.PelvicCurtainOddsLow_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_PelvicFlashRisk_Male)
			If AND_Main.NPCPelvicCurtainRoll <= AND_Config.PelvicCurtainOdds_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_PelvicFlashRiskHigh_Male)
			If AND_Main.NPCPelvicCurtainRoll <= AND_Config.PelvicCurtainOddsHigh_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_PelvicFlashRiskExtreme_Male)
			If AND_Main.NPCPelvicCurtainRoll <= AND_Config.PelvicCurtainOddsExtreme_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_PelvicFlashRiskUltra_Male)
			If AND_Main.NPCPelvicCurtainRoll <= AND_Config.PelvicCurtainOddsUltra_Male
				return False
			Else
				return True
			EndIf
	...
	ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_PelvicCurtainT_Male) || ScannedActor.WornHasKeyword(AND_Main.AND_MiniskirtT_Male)
		If ScannedActor.WornHasKeyword(AND_Main.AND_PelvicFlashRiskLow_Male)
			If AND_Main.NPCPelvicCurtainRoll <= AND_Config.TransparentPelvicCurtainOddsLow_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_PelvicFlashRisk_Male)
			If AND_Main.NPCPelvicCurtainRoll <= AND_Config.TransparentPelvicCurtainOdds_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_PelvicFlashRiskHigh_Male)
			If AND_Main.NPCPelvicCurtainRoll <= AND_Config.TransparentPelvicCurtainOddsHigh_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_PelvicFlashRiskExtreme_Male)
			If AND_Main.NPCPelvicCurtainRoll <= AND_Config.TransparentPelvicCurtainOddsExtreme_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_PelvicFlashRiskUltra_Male)
			If AND_Main.NPCPelvicCurtainRoll <= AND_Config.TransparentPelvicCurtainOddsUltra_Male
				return False
			Else
				return True
			EndIf
...
Bool Function AssCurtainCheck(Actor ScannedActor)
	If ScannedActor.WornHasKeyword(AND_Main.AND_AssCurtain_Male) || ScannedActor.WornHasKeyword(AND_Main.AND_Miniskirt_Male)
		If ScannedActor.WornHasKeyword(AND_Main.AND_AssFlashRiskLow_Male)
			If AND_Main.NPCAssCurtainRoll <= AND_Config.AssCurtainOddsLow_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_AssFlashRisk_Male)
			If AND_Main.NPCAssCurtainRoll <= AND_Config.AssCurtainOdds_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_AssFlashRiskHigh_Male)
			If AND_Main.NPCAssCurtainRoll <= AND_Config.AssCurtainOddsHigh_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_AssFlashRiskExtreme_Male)
			If AND_Main.NPCAssCurtainRoll <= AND_Config.AssCurtainOddsExtreme_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_AssFlashRiskUltra_Male)
			If AND_Main.NPCAssCurtainRoll <= AND_Config.AssCurtainOddsUltra_Male
				return False
			Else
				return True
			EndIf
	...
	ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_AssCurtainT_Male) || ScannedActor.WornHasKeyword(AND_Main.AND_MiniskirtT_Male)
		If ScannedActor.WornHasKeyword(AND_Main.AND_AssFlashRiskLow_Male)
			If AND_Main.NPCAssCurtainRoll <= AND_Config.TransparentAssCurtainOddsLow_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_AssFlashRisk_Male)
			If AND_Main.NPCAssCurtainRoll <= AND_Config.TransparentAssCurtainOdds_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_AssFlashRiskHigh_Male)
			If AND_Main.NPCAssCurtainRoll <= AND_Config.TransparentAssCurtainOddsHigh_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_AssFlashRiskExtreme_Male)
			If AND_Main.NPCAssCurtainRoll <= AND_Config.TransparentAssCurtainOddsExtreme_Male
				return False
			Else
				return True
			EndIf
		ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_AssFlashRiskUltra_Male)
			If AND_Main.NPCAssCurtainRoll <= AND_Config.TransparentAssCurtainOddsUltra_Male
				return False
			Else
				return True
			EndIf
...
Bool Function BottomTransparentArmorCheck(Actor ScannedActor)
	If ScannedActor.WornHasKeyword(AND_Main.AND_ArmorBottomT_Low_Male)
		If AND_Main.NPCBottomTransparentRoll <= AND_Config.TransparentBottomArmorOdds_Low_Male
			return False
		Else
			return True
		EndIf
	ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_ArmorBottomT_Male)
		If AND_Main.NPCBottomTransparentRoll <= AND_Config.TransparentBottomArmorOdds_Male
			return False
		Else
			return True
		EndIf
	ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_ArmorBottomT_High_Male)
		If AND_Main.NPCBottomTransparentRoll <= AND_Config.TransparentBottomArmorOdds_High_Male
			return False
		Else
			return True
		EndIf
...
Bool Function TransparentHotpantsCheck(Actor ScannedActor)
	If ScannedActor.WornHasKeyword(AND_Main.AND_HotpantsT_Low_Male)
		If AND_Main.NPCHotpantsTransparentRoll <= AND_Config.TransparentHotpantsOdds_Low_Male
			return False
		Else
			return True
		EndIf
	ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_HotpantsT_Male)
		If AND_Main.NPCHotpantsTransparentRoll <= AND_Config.TransparentHotpantsOdds_Male
			return False
		Else
			return True
		EndIf
	ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_HotpantsT_High_Male)
		If AND_Main.NPCHotpantsTransparentRoll <= AND_Config.TransparentHotpantsOdds_High_Male
			return False
		Else
			return True
		EndIf
...
Bool Function TransparentShowgirlCheck(Actor ScannedActor)
	If ScannedActor.WornHasKeyword(AND_Main.AND_HimboSkirtT_Low)
		If AND_Main.NPCShowgirlTransparentRoll <= AND_Config.TransparentShowgirlSkirtOdds_Low_Male
			return False
		Else
			return True
		EndIf
	ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_HimboSkirtT)
		If AND_Main.NPCShowgirlTransparentRoll <= AND_Config.TransparentShowgirlSkirtOdds_Male
			return False
		Else
			return True
		EndIf
	ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_HimboSkirtT_High)
		If AND_Main.NPCShowgirlTransparentRoll <= AND_Config.TransparentShowgirlSkirtOdds_High_Male
			return False
		Else
			return True
		EndIf
...
Bool Function TransparentUnderwearCheck(Actor ScannedActor)
	If ScannedActor.WornHasKeyword(AND_Main.AND_UnderwearT_Low_Male) || ScannedActor.WornHasKeyword(AND_Main.AND_ThongT_Low_Male)
		If AND_Main.NPCUnderwearTransparentRoll <= AND_Config.TransparentUnderwearOdds_Low_Male
			return False
		Else
			return True
		EndIf
	ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_UnderwearT_Male) || ScannedActor.WornHasKeyword(AND_Main.AND_ThongT_Male)
		If AND_Main.NPCUnderwearTransparentRoll <= AND_Config.TransparentUnderwearOdds_Male
			return False
		Else
			return True
		EndIf
	ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_UnderwearT_High_Male) || ScannedActor.WornHasKeyword(AND_Main.AND_ThongT_High_Male)
		If AND_Main.NPCUnderwearTransparentRoll <= AND_Config.TransparentUnderwearOdds_High_Male
			return False
		Else
			return True
		EndIf
...
Bool Function CStringCheck(Actor ScannedActor)
	If ScannedActor.WornHasKeyword(AND_Main.AND_BananaHammock)
		If AND_Main.NPCCstringRoll <= AND_Config.CStringOdds_Male
			return False
		Else
			return True
		EndIf
	ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_BananaHammockT_Low)
		If AND_Main.NPCCstringRoll <= AND_Config.TransparentCStringOdds_Low_Male
			return False
		Else
			return True
		EndIf
	ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_BananaHammockT)
		If AND_Main.NPCCstringRoll <= AND_Config.TransparentCStringOdds_Male
			return False
		Else
			return True
		EndIf
	ElseIf ScannedActor.WornHasKeyword(AND_Main.AND_BananaHammockT_High)
		If AND_Main.NPCCstringRoll <= AND_Config.TransparentCStringOdds_High_Male
			return False
		Else
			return True
		EndIf
...
Function AND_LayerAnalyze(Actor ScannedActor, String akName = "")
	Logger.Log("<NPC Male Armor Scan> [Layer Analyze] Male (NPC) Armor Scan Started for " + ScannedActor + " " + akName)
	...
	Logger.Log("<NPC Male Armor Scan> [Layer Analyze] Male (NPC) Armor Scan Finished for " + ScannedActor + " " + akName)
EndFunction